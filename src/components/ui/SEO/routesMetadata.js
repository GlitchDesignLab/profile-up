export const routesMetadata = [
  ...
  {
    path: "/",
    title: "Inicio - Profile Up | Recursos Humanos y Psicología",
    description:
  ...
  {
    path: "/about",
    title: "Sobre mí - Matías Martínez | Profile Up",
    description:
  ...
  {
    path: "/contacto",
    title: "  Contacto - Profile Up | Recursos Humanos y Psicología",
    description:
  ...
  //   Rrhh
  {
    path: "/rrhh",
    title:
      "Recursos Humanos - Profile Up | Selección Laboral y Gestión de Talento",
    description:
